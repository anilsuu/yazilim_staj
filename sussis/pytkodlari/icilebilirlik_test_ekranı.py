...
#Girilecek parametrelerin .input olarak veri tipini belirterek
        ph = float(st.number_input("💧 pH Seviyesi", step=1.0, min_value=0.22749905, max_value=14.0, help="0-14 değerleri arasında olmalıdır.")) 
